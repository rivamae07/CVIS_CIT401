...
use Carbon\Carbon;
class MobileReturnProductsController extends Controller
{
    public function returnProduct(){
        return view ('mobilereturn_products.return');
    }
            ...
            if($item['quantity'] && $item['quantity'] > 0){
                ...
                if($psq->location == 'MCV'){
                    ...
                    if($psq->location == 'MCV'){
                        ...
                        flash('You cannot insert a return product in the San Pedro City Hall Center')->warning();
                    }
                }else{
                    flash('You cannot insert a return product in the San Pedro City Hall Center')->warning();
                }
    ...
    public function history(){
        ...
        return view('mobilereturn_products.history', compact('return_products'));
    }
    ...
    public function today()
    {
        ...
        return view('mobilereturn_products.returnPrint', compact('return_products'));
    }
