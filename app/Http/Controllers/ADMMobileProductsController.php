...
class ADMMobileProductsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('ADMmobileproducts.index', compact('products'));
    }
    ...
    public function report(){
        ...
        return view('ADMmobileproducts.report', compact('products'));
    }
    ...
    public function show($id)
    {
        ...
        return view('ADMmobileproducts.show', compact('products'));
    }
