...
class MobileRequestsController extends Controller
{
    public function request(){
        return view ('mobilerequests.request');
    }
        ...
        foreach ($request->items as $item){
            if($item['quantity'] && $item['quantity'] > 0){
                ...
                if($psq->location == 'MCV'){
                    ...
                    flash('You cannot insert a request in the San Pedro City Hall Center')->warning();
                }
            }else{
    ...
    public function history(){
        ...
        return view('mobilerequests.history', compact('requests'));
    }
}
