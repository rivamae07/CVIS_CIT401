...
class ADMMobileSoldProductsController extends Controller
{
    public function soldProduct(){
        return view ('ADMmobilesold_products.sold');
    }

    public function history(){
        $sold_products = SoldProduct::with(['product', 'size'])->orderBy('created_at', 'DESC')->where('utype', 'MCV')->get();
        return view('ADMmobilesold_products.history', compact('sold_products'));
    }

    public function today(){
        $sold_products = SoldProduct::with(['product', 'size'])->whereDate('date', Carbon::today())->orderBy('created_at', 'DESC')->where('utype', 'MCV')->get();
        return view('ADMmobilesold_products.soldPrint', compact('sold_products'));
    }
