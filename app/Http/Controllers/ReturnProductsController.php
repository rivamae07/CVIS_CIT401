...
class ReturnProductsController extends Controller
{
    ...
    public function today(){
        $return_products = ReturnProduct::with(['product', 'size'])->whereDate('date', Carbon::today())->orderBy('created_at', 'DESC')->get();
        return view('return_products.returnPrint', compact('return_products'));
    }

    public function month(){
        $date = Carbon::today()->subDays(30);
        $return_products = ReturnProduct::with(['product', 'size'])->where('date', '>=', $date)->orderBy('created_at', 'DESC')->get();
        return view('return_products.returnPrint', compact('return_products'));
    }
