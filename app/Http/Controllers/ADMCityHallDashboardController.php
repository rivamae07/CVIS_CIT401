...
class ADMCityHallDashboardController extends Controller
{ 
    public function ADMCityHallIndex(){
        //Recent Products
        ...
        $MO_total_requests = ProductRequest::where('status', ProductRequest::STOCK_IN)->where('utype', 'CHV')->where('date','>=',$date)->get()->count();
        ...
        return view('ADM-cityhall-dashboard', compact('total_products', 'total_users', 'total_return_products', 'total_sold_products', 'total_requests',
