              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="small-box bg-primary">
                    ...
                    <a href="{{ route('ADMcityhallusers.index') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-info">
                    ...
                    <a href="{{ route('ADMcityhallproducts.index') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-dark">
                    ...
                    <a href="{{ route('ADMcityhallrequestHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                ...
                <div class="col">
                  ...
                  <div class="small-box bg-danger">
                    ...
                    <a href="{{ route('ADMcityhallreturnProductHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-success">
                    ...
                    <a href="{{ route('ADMcityhallsoldProductHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              </div>
              </div>
