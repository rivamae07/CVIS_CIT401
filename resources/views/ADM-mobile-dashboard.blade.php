              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="small-box bg-primary">
                    ...
                    <a href="{{ route('ADMmobileusers.index') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-info">
                    ...
                    <a href="{{ route('ADMmobileproducts.index') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-dark">
                    ...
                    <a href="{{ route('ADMmobilerequestHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                ...
                <div class="col">
                  ...
                  <div class="small-box bg-danger">
                    ...
                    <a href="{{ route('ADMmobilereturnProductHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-success">
                    ...
                    <a href="{{ route('ADMmobilesoldProductHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              </div>
              </div>
                        ...
                        @if($recent_products)
                            @foreach($recent_products as $key => $product)
                                <tr>
                                    ...
                                    <td>
                                      <a href="{{ route('ADMmobileproducts.show', $product->id) }}" class="btn btn-sm btn-primary">
