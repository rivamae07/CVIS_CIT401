          ...
          <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card-body">
                  ...
                  <form role="form" action="{{ route('cityhallusers.store') }}" method="post" enctype="multipart/form-data">
                      @csrf
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input name="file" type="file" class="form-control" placeholder="Enter Resume">
                        @if($errors->has('file'))
                      ...
                      <!-- <div class="form-group">
                        ...
                        <input name="utype" type="text" class="form-control" placeholder="Enter Branch">
                        @if($errors->has('utype'))
                            <span class="text-danger">{{ $errors->first('utype') }}</span>
                        @endif
                      </div> -->
