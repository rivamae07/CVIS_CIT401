          ...
          <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card-body">
                  ...
                  <form role="form" action="{{ route('cityhallusers.update', $user->id) }}" method="post" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input name="file" type="file" class="form-control" placeholder="Enter Resume" value="{{ $user->resume ?? '' }}">
                        @if($errors->has('file'))
