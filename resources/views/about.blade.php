        ...
        <div class="col">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white"
                ...
                <h5 class="widget-user-desc text-right">Project Team Member</h5>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header"><a  href="#"><i class="fab fa-facebook"></i></a></h5>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  ...
                  <div class="col-sm-4">
                    <div class="description-block">
                      <h5 class="description-header"><a  href="#"><i class="fab fa-instagram"></i></a></h5>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white"
                ...
                <h3 class="widget-user-username text-right">Jose Miguel Gamo</h3>
                <h5 class="widget-user-desc text-right">Project Team Member</h5>
              </div>
              <div class="widget-user-image">
                <img class="img-circle" src="{{ asset('storage/images/gamo.jpg') }}" alt="User Avatar">
              </div>
              <div class="card-footer">
              <div class="row">
                  <div class="col-sm-4 border-right">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white"
                ...
                <h5 class="widget-user-desc text-right">Project Manager</h5>
              </div>
              <div class="widget-user-image">
