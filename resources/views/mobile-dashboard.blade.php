              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="small-box bg-primary">
                    ...
                    <a href="{{ route('mobileusers.index') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-info">
                    ...
                    <a href="{{ route('mobileproducts.index') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-dark">
                    ...
                    <a href="{{ route('mobilerequestHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                ...
                <div class="col">
                  ...
                  <div class="small-box bg-danger">
                    ...
                    <a href="{{ route('mobilereturnProductHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col">
                  ...
                  <div class="small-box bg-success">
                    ...
                    <a href="{{ route('mobilesoldProductHistory') }}" class="text-white small-box-footer">More info &nbsp<i class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              </div>
              </div>
                        ...
                        @if($recent_products)
                            @foreach($recent_products as $key => $product)
                                <tr>
                                    ...
                                    <td>
                                      <a href="{{ route('mobileproducts.show', $product->id) }}" class="btn btn-sm btn-primary">
