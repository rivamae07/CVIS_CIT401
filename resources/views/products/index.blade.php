          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body" style="padding-bottom:0;">
                  ...
                  <a href="{{ route('productsPrintHistory') }}" class="btn btn-sm btn-primary d-inline float-right" style="margin-left:5px;"><i class="fa fa-table"></i> &nbsp; Generate Report </a>
                  <a href="{{ route('products.create') }}" class="btn btn-sm btn-success d-inline float-right"><i class="fa fa-plus"></i> &nbsp; Add Product </a>
