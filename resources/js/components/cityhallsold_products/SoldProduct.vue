        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <h5 class="card-title">Dispatched Product</h5>
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            <i
                                ...
                                Remember to set the quantity to zero if there
                                are no sales made for the size.</i
                            >
                        </p>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            store.dispatch(actions.CITYHALL_SUBMIT_SOLD_PRODUCT, this.form);
        }
    }
};
</script>
