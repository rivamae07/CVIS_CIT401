...
<div class="col-sm-6">
    ...
    <div class="card-body">
      ...
      <br />
        ...
        <div class="form-group">
            <label>Stock Keeping Unit <span class="text-danger">*</span></label>
            <input type="text" v-model="form.sku" class="form-control" placeholder="Enter Stock Keeping Unit">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" placeholder="Enter product image" @change="selectImage">
        </div>

        <div class="form-group">
            <label>Cost Price(₱) <span class="text-danger">*</span></label>
            <input type="number" v-model="form.cost_price" class="form-control" placeholder="Enter Product Cost Price">
        </div>

        <div class="form-group">
            <label>Expiration Date <span class="text-danger">*</span></label>
            <input type="date" v-model="form.expiration_date" class="form-control" placeholder="Enter Product Expiration Date">
        </div>

        <div class="form-group">
            <label>Year <span class="text-danger">*</span></label>
            <input type="text" v-model="form.year" class="form-control" placeholder="Enter Product Year (ex. 2021)">
        </div>

        <div class="form-group">
            <label>Description <span class="text-danger">*</span></label>
            <input type="text" v-model="form.description" class="form-control" placeholder="Enter Product Description (max: 200 characters)">
        </div>
...
<div class="col-sm-6">
    ...
    <div class="card-body">
        ...
        <div class="row mb-2" v-for="(item, index) in form.items" :key="index">
            ...
            <div class="col-sm-3">
                <select class="form-control" v-model="item.location">
            ...
            <div class="col-sm-2">
                <button type="button" class="btn-danger btn-sm" @click="deleteItem(index)">
                    <i class="fa fa-trash"></i>
                </button>
            </div>
        </div>

        <button class="btn btn-primary btn-sm mt-3" type="button" @click="addItem">
